...
int main() {
    ...
    PRINT_CONSTANT((gint) HINOKO_FW_ISO_CTX_MODE_IR_MULTIPLE);
    PRINT_CONSTANT((gint) HINOKO_FW_ISO_CTX_MODE_IR_SINGLE);
    PRINT_CONSTANT((gint) HINOKO_FW_ISO_CTX_MODE_IT);
