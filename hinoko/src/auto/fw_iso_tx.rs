...
glib::wrapper! {
    ...
    pub struct FwIsoTx(Object<ffi::HinokoFwIsoTx, ffi::HinokoFwIsoTxClass>) @extends FwIsoCtx;
...
pub trait FwIsoTxExt: 'static {
    ...
    #[doc(alias = "hinoko_fw_iso_tx_release")]
    fn release(&self);

    #[doc(alias = "hinoko_fw_iso_tx_stop")]
    fn stop(&self);

    #[doc(alias = "hinoko_fw_iso_tx_unmap_buffer")]
...
impl<O: IsA<FwIsoTx>> FwIsoTxExt for O {
    fn allocate(
        ...
        unsafe {
            ...
            let _ = ffi::hinoko_fw_iso_tx_allocate(
    ...
    fn map_buffer(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::hinoko_fw_iso_tx_map_buffer(
                self.as_ref().to_glib_none().0,
    ...
    fn release(&self) {
        unsafe {
            ffi::hinoko_fw_iso_tx_release(self.as_ref().to_glib_none().0);
        }
    }

    fn stop(&self) {
        unsafe {
            ffi::hinoko_fw_iso_tx_stop(self.as_ref().to_glib_none().0);
        }
    }

    fn unmap_buffer(&self) {
        unsafe {
            ffi::hinoko_fw_iso_tx_unmap_buffer(self.as_ref().to_glib_none().0);
        }
    }
}
